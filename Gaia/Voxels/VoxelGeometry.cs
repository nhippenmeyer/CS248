...
namespace Gaia.Voxels
{
    public class VoxelGeometry
    {
        ...
        public void GenerateGeometry(ref byte[] DensityField, byte IsoValue, int DensityFieldWidth, int DensityFieldHeight, int DensityFieldDepth, int Width, int Height, int Depth, int xOrigin, int yOrigin, int zOrigin, float ratio)
        {
            DestroyBuffers();
