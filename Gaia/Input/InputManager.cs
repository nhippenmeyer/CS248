...
namespace Gaia.Input
{
    ...
    public class InputManager
    {
        ...
        public void Update()
        {
            ...
            displacement = (centerCoord - new Vector2(currentMouseState.X, currentMouseState.Y)) / (GFX.Inst.DisplayRes / 2.0f);
            if (StickyInput)
        ...
        {
            return (new Vector2(currentMouseState.X, currentMouseState.Y) / GFX.Inst.DisplayRes) * 2.0f - Vector2.One;
        }
