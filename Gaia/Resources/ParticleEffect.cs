            ...
            foreach (XmlAttribute attrib in node.Attributes)
            {
                switch (attrib.Name.ToLower())
                {
                    ...
                    case "initialdirection":
                        initialDirection = ResourceManager.Inst.ParseVector3(attrib.Value);
                        break;
                    ...
                    case "randomoffset":
                        offsetParameters = new Vector4(ResourceManager.Inst.ParseVector3(attrib.Value), offsetParameters.W);
                        break;
